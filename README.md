...
| ATS Scoring | Text + JD keywords | Score 0–100 + gap list | TF-IDF keyword match |
...
ATS scoring runs *before* any LLM call. It uses keyword frequency analysis against extracted JD terms. This serves two purposes:
...
- **Keyword match score (0–100):** Fraction of JD-extracted keywords present in the resume, weighted by term frequency in the JD.
